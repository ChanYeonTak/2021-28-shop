...
var f = document.userForm;
var passwdEl = f.userwd;
var passwd2El = f.userpw2;
var usernameEl = f.username;
var emailEl = f.email;
var useridTxt = document.querySelector('form[name="userForm"] .userid');
var passwdTxt = document.querySelector('form[name="userForm"] .passwd');
var passwd2Txt = document.querySelector('form[name="userForm"] .passwd2');
var usernameTxt = document.querySelector('form[name="userForm"] .username');
var emailTxt = document.querySelector('form[name="userForm"] .email');
...
function onApikey() {
  if (confirm('APIKey를 적용하면 바로 적용됩니다.\n적용 후에는 되돌릴 수 없습니다.')) {
